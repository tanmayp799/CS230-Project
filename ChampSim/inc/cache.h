...
#define L1D_LATENCY int(1.75+L1D_SET/256+L1D_WAY/4)
...
#define L2C_LATENCY int(4+L2C_SET/256+L2C_WAY/4)  // 4/5 (L1I or L1D) + 10 = 14/15 cycles
...
#define LLC_LATENCY int(8+LLC_SET/256+LLC_WAY/4)  // 4/5 (L1I or L1D) + 10 + 20 = 34/35 cycles
